            ...
            switch (holder.getItemViewType()) {
                ...
                case 2: {
                    ...
                    if (position == idRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("Message", R.string.Message), messageObject.messageText, divider);
                    } else if (position == captionRow) {
                        textCell.setTextAndValue(LocaleController.getString("Caption", R.string.Caption), messageObject.caption, divider);
                    } else if (position == channelRow || position == groupRow) {
                        ...
                        textCell.setTextAndValue(position == channelRow ? LocaleController.getString("AccDescrChannel", R.string.AccDescrChannel) : LocaleController.getString("AccDescrGroup", R.string.AccDescrGroup), builder.toString(), divider);
                    } else if (position == fromRow) {
                        StringBuilder builder = new StringBuilder();
                        if (fromUser != null) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("From", R.string.From), builder.toString(), divider);
                        ...
                        if (messageObject.scheduled) {
                            if (messageObject.messageOwner.date == 0x7ffffffe) {
                                textCell.setTextAndValue(LocaleController.getString("MessageScheduledUntilOnline", R.string.MessageScheduledUntilOnline), LocaleController.getString("CheckPhoneNumberYes", R.string.CheckPhoneNumberYes), divider);
                            } else {
                                textCell.setTextAndValue(LocaleController.formatString("MessageScheduledOn", R.string.MessageScheduledOn, ""), timeString, divider);
                            }
                        } else {
                            textCell.setTextAndValue(LocaleController.formatString("Date", R.string.Date), timeString, divider);
                        }
                        ...
                        StringBuilder builder = new StringBuilder();
                        builder.append(LocaleController.getString("From", R.string.From)).append(" ");
                        ...
                        textCell.setTextAndValue(LocaleController.formatString("StoragePath", R.string.StoragePath), filePath, divider);
                    } else if (position == fileSizeRow) {
                        textCell.setTextAndValue(LocaleController.formatString("Filesize", R.string.Filesize), AndroidUtilities.formatFileSize(messageObject.getSize()), divider);
                        ...
                        textCell.setTextAndValue(LocaleController.formatString("AutoNightScheduled", R.string.AutoNightScheduled), LocaleController.getString("CheckPhoneNumberYes", R.string.CheckPhoneNumberYes), divider);
